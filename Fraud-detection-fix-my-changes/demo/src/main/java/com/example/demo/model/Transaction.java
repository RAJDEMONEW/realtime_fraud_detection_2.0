...
import com.example.demo.enums.Merchant;    
...
import static com.example.demo.enums.Merchant.getRandomMerchant;
...
public class Transaction {
    ...
    // public Transaction(Object object, String string, String string2, double amount2, Currency currency2, Instant instant, Merchant merchant2, Category category2, boolean b) {}
public Transaction(String id, String transactionId, String userId, double amount,
                   Currency currency, Instant timestamp, Merchant merchant,
                   Category category, boolean isFraud) {
    this.id = id;
